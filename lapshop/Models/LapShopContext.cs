...
public partial class LapShopContext : IdentityDbContext<IdentityUser>
{
    ...
    public virtual DbSet<HomePageSetting> TbHomePageSetting { get; set; }
    ...
    public DbSet<itemsCategoriseView> ViewItemCategory { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server= DESKTOP-AJ4UL8D\\SQLEXPRESS;Database=LapShop;Trusted_Connection=True;TrustServerCertificate=Yes");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HomePageSetting>(e => {

            e.HasKey(e => e.HomePageId);
        ...
        modelBuilder.Entity<itemsCategoriseView>(entity => {

            entity.HasNoKey();
            entity.ToView("VwitemCategoryView");
